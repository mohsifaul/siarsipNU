<div class="modal fade" tabindex="-1" role="dialog" id="tambahProker">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Program Kerja</h5>
            </div>
            <form id="prokerForm" class="needs-validation" novalidate method="POST" action="{{ route('proker.store') }}"
...
<script>
    $('#prokerForm').on('submit', function(e) {
        e.preventDefault();
